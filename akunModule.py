...
class AkunTutor :
    def __init__(self, usernameS):
        ...
        self.balance = Label(self.frame1, text="IDR "+self.toCurrency(self.balanceS), font = "Arial 10 bold")
        ...
        self.tarif = Label(self.frame1, text = self.toCurrency(self.tarifS)+"/session", font = "Arial 10")
        self.tarif.grid(row = 1, column = 1, sticky = "e")
        self.kontak = Label(self.frame1, text ="Kontak\t: " + self.kontakS, font = "Arial 10")
        self.kontak.grid(row = 2, column = 0, sticky = "w")
        self.rating = Label(self.frame1, text = "Rating\t: "+ str(self.ratingS) + "/5.0", font = "Arial 10")
        self.rating.grid(row = 3, column = 0, sticky = "w")

        self.update = Button(self.frame1, text="Update Info", pady=5, command=self.update)
        ...
        self.heading1 = Label(self.frame2, text = "About Me", font = "Arial 12 bold")
        self.heading1.grid(sticky = "w")
        self.headline = Label(self.frame2, text = self.headlineS, font = "Arial 10")
        ...
        self.heading2 = Label(self.frame3, text = "Experience", font = "Arial 12 bold")
        ...
        self.heading3 = Label(self.frame4, text = "Education", font = "Arial 12 bold")
...
class UpdateAkun :
    def __init__(self, usernameS):
        ...
        self.jenjang = Combobox(self.frame1, state ="readonly", font = "Arial 10" ,width = 5, textvariable = self.jenjangClicked)
        ...
        self.frame2.pack(side = TOP, fill="both", padx=20, pady = 10)
        #Pengalaman
        self.label6 = Label(self.frame2, text = "Experience\t:", font = "Arial 10", pady = 5)
        self.label6.grid(row = 0, column = 0, sticky = "nw")
        self.pengalaman = Text(self.frame2, font = "Arial 10", height = 4, width = 60, wrap=WORD)
        ...
        #Pendidikan
        self.label7 = Label(self.frame2, text = "Education\t:", font = "Arial 10",pady = 5)
        self.label7.grid(row = 2, column = 0, sticky = "nw")
        self.pendidikan = Text(self.frame2, font = "Arial 10" ,height = 4, width = 60, wrap=WORD)
        ...
        #Headline
        self.label8 = Label(self.frame2, text = "Headline\t:", font = "Arial 10",pady = 5)
        self.label8.grid(row = 4, column = 0, sticky = "nw")
        self.headline = Text(self.frame2, font = "Arial 10" ,height = 4, width = 60, wrap=WORD)
        ...
        self.back = Button(self.frame3,text='back',padx = 5,command=self.exit_btn)
        self.back.grid(row = 0, column = 1, sticky = "e")
        self.update = Button(self.frame3, text="Submit", padx = 5,command=self.update)
    ...
    def update(self):
        ...
        try :
            ...
            cursor.execute("UPDATE user SET nama = '"+self.namaS+"', kontak = '"+self.kontakS+"', alamat = '"+self.alamatS+"' WHERE username = '"+self.usernameS+"'")
            cursor.execute('commit')
            try:
                cursor.execute("UPDATE tutor SET jenjang = '"+self.jenjangS+"', tarif = '"+str(self.tarifS)+"', pengalaman = '"+self.pengalamanS+"', pendidikan = '"+self.pendidikanS+"', headline = '"+self.headlineS+"' WHERE username = '"+self.usernameS+"'")
                cursor.execute('commit')
                messagebox.showinfo('Successful', 'Your account has been updated')
                self.akun.destroy()
            except:
                messagebox.showwarning("Warning", 'There is an error in your input')
        except :
            messagebox.showwarning("Warning", 'There is an error in your input')
